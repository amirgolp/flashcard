    ...
    <Box>
      ...
      <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap', mb: 2 }}>
        ...
        {book.target_language && (
          <Chip label={book.target_language} color="primary" />
        )}
        {book.native_language && (
          <Chip label={book.native_language} color="secondary" />
        )}
      </Box>
      ...
      <Dialog open={confirmOpen} onClose={() => setConfirmOpen(false)}>
        ...
        <DialogContent>
          <DialogContentText>
            ...
            delete all associated progress and draft cards.
          </DialogContentText>
        </DialogContent>
        <DialogActions>
