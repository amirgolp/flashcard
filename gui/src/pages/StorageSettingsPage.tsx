  ...
  return (
    <Box>
      ...
      <Typography variant="body1" color="text.secondary" sx={{ mb: 4 }}>
        By default, your PDF files are stored in the app's central storage.
        Optionally, connect your own Telegram or Google Drive for personal
        storage.
      </Typography>
          ...
          {config.is_configured ? (
            <Stack spacing={2}>
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                ...
                <Box>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    Using:{' '}
                    {config.storage_type === 'telegram'
                      ? 'Telegram'
                      : config.storage_type === 'google_drive'
                        ? 'Google Drive'
                        : 'App Storage'}
                  </Typography>
                </Box>
              ...
              <Box>
                ...
                <LinearProgress
                  ...
                  sx={{
                    ...
                    '& .MuiLinearProgress-bar': {
                      bgcolor:
                        usedPercentage > 80 ? 'error.main' : 'primary.main',
                    },
                  }}
                />
                <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap' }}>
                  <Chip
                    ...
                    size="small"
                    color={
                      config.quota.file_count >= config.quota.max_files
                        ? 'error'
                        : 'default'
                    }
                  />
              ...
              <Button
                ...
                disabled={
                  disconnectMutation.isPending || config.quota.file_count > 0
                }
              >
                Disconnect Storage
              </Button>
            ...
            <Alert severity="info" icon={<InfoIcon />}>
              Using app-managed storage (default). Connect your own Telegram or
              Google Drive below for personal storage.
            </Alert>
          )}
        </Paper>
      )}
        ...
        <Box sx={{ p: 3 }}>
            ...
            <Box>
              ...
              <Alert severity="info" sx={{ mb: 3 }}>
                ...
                <ol style={{ marginTop: 8, marginBottom: 0, paddingLeft: 20 }}>
                  ...
                  <li>
                    Send <code>/newbot</code> and follow the instructions
                  </li>
          ...
          {activeTab === 1 && (
            <Box>
              ...
              <Alert severity="info" sx={{ mb: 3 }}>
                Files will be stored in your personal Google Drive. You'll need
                to grant permission for the app to upload and manage files.
              </Alert>
